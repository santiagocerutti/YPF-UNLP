...
Los programas de fidelización buscan fortalecer la identificación de los usuarios con la marca y construir relaciones de largo plazo con los clientes. A través de distintos incentivos, estos programas procuran no solo retener consumidores, sino también incrementar su nivel de consumo tanto en el corto como en el largo plazo. En este sentido, constituyen una herramienta comercial orientada a modificar patrones de demanda y profundizar el vínculo entre la empresa y su base de clientes.

La pregunta central es cómo evaluar rigurosamente si los programas de fidelización efectivamente logran modificar el comportamiento de los consumidores y aumentar su demanda. Una comparación ingenua consistiría en contrastar el consumo de los usuarios adheridos al programa con el de aquellos que no participan. Sin embargo, esta diferencia difícilmente pueda atribuirse de manera directa al efecto del programa, ya que ambos grupos pueden diferir en características previas. Por ejemplo, si en una estación se observa que los usuarios adheridos al programa cargan más combustible que los no adheridos, ello no implica necesariamente que el programa incentive un mayor consumo. Es posible que quienes se afilian sean precisamente conductores con mayor intensidad de uso del vehículo o clientes habituales de la estación, que habrían consumido más incluso en ausencia del programa. 

En consecuencia, el principal desafío metodológico consiste en identificar los efectos causales del programa sobre el comportamiento de demanda, aislándolos de diferencias preexistentes entre tipos de consumidores. El objetivo de este bloque es superar las comparaciones meramente descriptivas y estimar de manera rigurosa el impacto del programa, o de alguna intervencion especifica del programa, sobre ventas, composición del consumo y márgenes comerciales. 

Para ello, se propone una batería de tres ejercicios empíricos complementarios, cada uno orientado a identificar una dimensión específica del impacto del programa. Estos ejercicios pueden implementarse de manera conjunta y sus resultados se refuerzan mutuamente, permitiendo construir una evaluación integral de la efectividad del programa de fidelización. Este bloque se beneficiará del hecho de que ademas de su función comercial, los programas de fidelización generan información detallada sobre el comportamiento de consumo de los usuarios y su respuesta a distintos incentivos. Estos datos permiten conocer con mayor precisión los hábitos de compra, la frecuencia de consumo y las decisiones de los clientes frente a promociones y beneficios, aportando insumos valiosos para el diseño de estrategias comerciales.

%Los programas de fidelización no solo buscan retener clientes y aumentar su consumo: también generan datos valiosos sobre comportamiento de consumo y respuesta a incentivos.
%Sin embargo, el hecho de que los socios consuman más que los no socios no implica que el programa cause ese mayor consumo. Puede simplemente reflejar que quienes más cargan nafta son también quienes más se afilian. El objetivo de esta propuesta es ir más allá de esa comparación descriptiva y estimar el efecto causal del programa sobre ventas, mix de productos y márgenes.
...
\begin{figure}
    \centering
    \caption{Esquema ilustrativo de la Triple Diferencia}
    \label{fig:ddd}
